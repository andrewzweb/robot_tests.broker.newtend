...
${url.tender_single_lot}    ${HOST}/opc/provider/create-tender/singlelot/belowThreshold/tender/
${url.tender_reporting}     ${HOST}/opc/provider/create-tender/singlelot/reporting/tender/
${url.tender_negotiation}   ${HOST}/opc/provider/create-tender/singlelot/negotiation/tender/
${url.tender_multilots}     ${HOST}/opc/provider/create-tender/multilot/belowThreshold/tender/
...
# search tender
${page_search_tender}  ${HOST}/opc/provider/home/
