...
${page.sarch_plans}              ${HOST}/opc/provider/plans/all/?pageNum=1&query=&status=&procurementMethodType=&amount_gte=&amount_lte=&createReport=&create_gte=&create_lte=&tp_gte=&tp_lte=
