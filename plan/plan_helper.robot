...
Пошук плана
  ...
  Go To  https://autotest.newtend.com/opc/provider/plans/all/?pageNum=1&query=${plan_id}&status=&procurementMethodType=&amount_gte=&amount_lte=&createReport=&create_gte=&create_lte=&tp_gte=&tp_lte=
