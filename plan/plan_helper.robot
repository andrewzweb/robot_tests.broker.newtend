...
Пошук плана
  ...
  Go To  ${HOST}/opc/provider/plans/all/?pageNum=1&query=${plan_id}&status=&procurementMethodType=&amount_gte=&amount_lte=&createReport=&create_gte=&create_lte=&tp_gte=&tp_lte=
...
Перейти до редагування плану
  ...
  # get edit PLAN page
  Go To  ${HOST}/opc/provider/plans/${plan_id}/edit
  Sleep  10
