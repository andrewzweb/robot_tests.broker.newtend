...
Choise Bid
  ...
  ${white_list_of_tenders}=  Create List  esco  competitiveDialogueUA  competitiveDialogueUA  belowThreshold  aboveThresholdEU  aboveThresholdUA  competitiveDialogueEU.stage2
